...
class MockConfig:
      ...
      # EnALSModel params
      anomaly_latent_dim=32; anomaly_state_type="GRU"
      anomaly_loss_weight=0.05; anomaly_threshold=0.02
...
from models import EnhancTrAISformer,EnALSModel
from utils_training2 import setup_trainer
def main():
